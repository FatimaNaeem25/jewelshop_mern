...
function Card() {
  return (
    <div className='flex flex-row flex-wrap mx-2 md:mx-4 lg:mx-8 items-center justify-center'>
      <div className='bg-white shadow-lg border rounded-2xl p-4 m-2 w-72 text-center flex flex-col justify-between
      transform transition-transform duration-300 hover:scale-105 cursor-pointer'>
        <div className="flex justify-center items-center mb-2">
          <LiaShippingFastSolid className='text-[28px] text-gray-400' />
        </div>
